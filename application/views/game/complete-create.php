                  ...
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="final_form">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" autocomplete="Full name" placeholder="Full name">
                      </div>
                      <div class="form-group">
                        <label for="email">Email address <span class="text-danger">*</span></label>
                        <input type="email" name="email"  class="form-control" id="email" placeholder="Email">
                        <small class="emailer text-danger"></small>
                      </div>
                      <div class="form-group">
                        ...
                        <small class="userer text-danger"></small>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="mt-3">
                        <button type="button" id="finishToAccount" class="btn btn-primary text-white mr-2 mb-2 mb-md-0">
