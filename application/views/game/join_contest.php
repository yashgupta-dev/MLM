    ...
    <div class="row" style="margin-top:70px;">
        <div class="col-md-12">
            <div class="card" style="border-radius:12px;">
                <div class="card-body">
                    <div>
                        <form method="post" action="<?=base_url()?>api/form-procceedto">
                            <div class="form-group">
                                ...
                                <select class="form-control <?php if($this->session->flashdata('error')) echo ' is-invalid';?>" name="pkg" id="pkg">
                                    ...
                                    <?php $pkg = $this->db->where('isActive !=','2')->where('forAdmin','1')->select('name,price,id')->order_by('id','asc')->limit(1)->from('package')->get()->result();?>
                            ...
                            <div class="form-group">
                                <button id="procceedtoapy" type="submit" class="btn btn-block btn-success">Procceed To Active</button>
                            </div>
                        </form>
                    </div>
                </div>
