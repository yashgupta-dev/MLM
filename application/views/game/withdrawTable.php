            ...
            <div class="card" style="border-radius:12px;">
                <div class="card-body">
                    <table class="table table-borderless table-responsive">
                        <tbody>
                <?php $allda = $this->db->where('gate','app')->where('user',$this->session->userdata('gameuser'))->where('order','Withdraw Amount')->order_by('id','desc')->select('txn,method,t_amt,dr_cr,order,refrence,timestamp,status')->from('transaction')->get()->result();?>
